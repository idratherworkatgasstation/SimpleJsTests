...
pRestore.prototype = {
  ...
  restoreByNumberBtn() {
    return this.restoreByBlock("[data-l='t,phone']");
  },
  restoreByEmailBtn() {
    return this.restoreByBlock("[data-l='t,email']");
  },
  ...
  restoreByNumberTitle() {
    return this.restoreByNumberModule(".ext-registration_h");
  },
};
